 ...
 */
     ...
     */
        ...
        public static function aliasComponent($path, $alias = null)
        {
                    ...
                    /**
         * Register an includes alias directive.
         *
         * @param string $path
         * @param string|null $alias
         * @return void
...
namespace  {
            ...
            public static function orWhereDoesntHaveMorph($relation, $types, $callback = null)
            {
                ...
                /**
             * Add subselect queries to includes an aggregate value for a relationship.
             *
             * @param mixed $relations
             * @param string $column
            ...
            public static function withCount($relations)
            {
                ...
                /**
             * Add subselect queries to includes the max of the relation's column.
             *
            ...
            public static function withMax($relation, $column)
            {
                ...
                /**
             * Add subselect queries to includes the min of the relation's column.
             *
             * @param string|array $relation
             * @param string $column
             * @return \Illuminate\Database\Eloquent\Builder|static
            ...
            public static function withMin($relation, $column)
            {
                ...
                /**
             * Add subselect queries to includes the sum of the relation's column.
             *
             * @param string|array $relation
             * @param string $column
             * @return \Illuminate\Database\Eloquent\Builder|static
            ...
            public static function withSum($relation, $column)
            {
                ...
                /**
             * Add subselect queries to includes the average of the relation's column.
             *
             * @param string|array $relation
             * @param string $column
             * @return \Illuminate\Database\Eloquent\Builder|static
            ...
            public static function withAvg($relation, $column)
            {
                ...
                /**
             * Add subselect queries to includes the existence of related models.
             *
             * @param string|array $relation
             * @return \Illuminate\Database\Eloquent\Builder|static
             * @static
